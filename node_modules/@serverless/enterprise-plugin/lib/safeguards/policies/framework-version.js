...
module.exports = function frameworkVersionPolicy(policy, service, versionRange) {
  if (!semver.satisfies(service.frameworkVersion, versionRange)) {
    policy.fail(`Serverless Framework version ${service.frameworkVersion} does not satisfy version requirement: ${versionRange}`);
  } else {
    policy.approve();
  }
};
...
//# sourceMappingURL=framework-version.js.map